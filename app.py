...
# ============================================
# IMAGEN DE FONDO - URL CORREGIDA
# ============================================
# Usamos una imagen que SÍ funciona (Bandera de Venezuela)
...
# Si quieres usar tu imagen, cambia la URL arriba
...
# ============================================
# ESTILOS - CON FONDO DE IMAGEN CORREGIDO
# ============================================
st.markdown(f"""
<style>
/* Fondo de la aplicación con imagen */
.stApp {{
        ...
        if not tiktoks.empty:
            for _, t in tiktoks.iterrows():
                with st.expander(f"📱 {t['titulo']}"):
                    st.markdown(f"[Ver en TikTok]({t['tiktok_url']})")
        ...
        if not tiktoks.empty:
            for _, tik in tiktoks.iterrows():
                with st.expander(f"📱 {tik['titulo']}"):
                    st.markdown(f"[Ver en TikTok]({tik['tiktok_url']})")
