...
/* Estrellas CENTRADAS en el medio de la pantalla */
.stApp::before {
    content: "★ ★ ★ ★ ★ ★ ★ ★";
    position: fixed;
    top: 50%;
...
/* ============================================ */
/* TODAS LAS LETRAS EN BLANCO FUERTE */
/* ============================================ */
.main, 
.main p, 
.main span, 
...
# ============================================
# ⚠️ CAMBIA ESTA URL por la foto real de Santa Teresa del Tuy
# Puedes subir una foto a Imgur o a Supabase Storage y poner la URL aquí
...
<div style="text-align: center; margin-bottom: 20px;">
    <div style="background: linear-gradient(rgba(0,0,0,0.6), rgba(0,0,0,0.6)), 
        ...
        <h1 style="color: #FFFFFF; text-shadow: 3px 3px 8px black; font-size: 3em; margin: 0;">Santa Teresa al Dia</h1>
...
# ============================================
# BOTONES DE COMPARTIR - CON INSTAGRAM
# ============================================
st.markdown(f"""
